# copied from https://github.com/vlievin/biva-pytorch
...
class DiscretizedMixtureLogits(Distribution):
    def __init__(self, nr_mix, logits):
        self.logits = logits
        self.nr_mix = nr_mix

    def log_prob(self, value):
        return - discretized_mix_logistic_loss(2 * value - 1, self.logits)
